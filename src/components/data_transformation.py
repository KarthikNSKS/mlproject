...
class DataTransformation:
    ...
    def get_data_transfomration_object(self):
        try:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            preprocessing_obj=self.get_data_transfomration_object()

            target_columns="math_score"
            input_feature_columns = ["writing_score", "reading_score"]
            ...
            logging.info(f"Applying preprocessingobject on training and test dataframe")
